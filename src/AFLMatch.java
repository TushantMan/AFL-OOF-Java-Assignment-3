    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (aflmatch.getHomeTeamScore1() > aflmatch.getAwayTeamScore1())
                System.out.println(aflmatch.getHomeTeam().getName() + " " + aflmatch.homeTeamScore() + " defeats "
                        + aflmatch.getAwayTeam().getName() + " " + aflmatch.awayTeamScore());
            else if (aflmatch.getHomeTeamScore1() < aflmatch.getAwayTeamScore1())
                System.out.println(aflmatch.getAwayTeam().getName() + " " + aflmatch.awayTeamScore() + " defeats "
                        + aflmatch.getHomeTeam().getName() + " " + aflmatch.homeTeamScore());
            else {
                if (aflmatch.getHomeTeamScore2() > aflmatch.getAwayTeamScore2())
                    ...
                    System.out.println(aflmatch.getAwayTeam().getName() + " " + aflmatch.awayTeamScore() + " drew with "
                            + aflmatch.getHomeTeam().getName() + " " + aflmatch.homeTeamScore());
